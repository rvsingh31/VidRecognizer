...
# Data generator class for feeding the data to the model
class dataGenerator(keras.utils.Sequence):
    ...
    # Yield One batch as a tuple of (X,Y)
    def __getitem__(self, idx):
        ...
        for index,each in enumerate(batch_x):
            ...
            #Add corresponding frames for segments
            for i in range(len(frames)):
                Xframes[i%self.segments].append(frames[i])

            #Add corresponding flows for segments                        
    ...
    # One hot encoding for ground truths
